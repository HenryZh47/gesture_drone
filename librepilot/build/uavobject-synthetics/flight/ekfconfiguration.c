...
void EKFConfigurationSetDefaults(UAVObjHandle obj, uint16_t instId)
{
    ...
    data.P.PositionNorth = 1.000000e+1f;
    data.P.PositionEast = 1.000000e+1f;
    data.P.PositionDown = 1.000000e+1f;
    data.P.VelocityNorth = 1.000000e+0f;
    data.P.VelocityEast = 1.000000e+0f;
    data.P.VelocityDown = 1.000000e+0f;
    data.P.AttitudeQ1 = 7.000000e-3f;
    data.P.AttitudeQ2 = 7.000000e-3f;
    data.P.AttitudeQ3 = 7.000000e-3f;
    data.P.AttitudeQ4 = 7.000000e-3f;
    data.P.GyroDriftX = 1.000000e-6f;
    data.P.GyroDriftY = 1.000000e-6f;
    data.P.GyroDriftZ = 1.000000e-6f;
    data.Q.GyroX = 1.000000e-2f;
    data.Q.GyroY = 1.000000e-2f;
    data.Q.GyroZ = 1.000000e-2f;
    data.Q.AccelX = 1.000000e-2f;
    data.Q.AccelY = 1.000000e-2f;
    data.Q.AccelZ = 1.000000e-2f;
    data.Q.GyroDriftX = 1.000000e-6f;
    data.Q.GyroDriftY = 1.000000e-6f;
    data.Q.GyroDriftZ = 1.000000e-6f;
    data.R.GPSPosNorth = 1.000000e+0f;
    data.R.GPSPosEast = 1.000000e+0f;
    data.R.GPSPosDown = 1.000000e+6f;
    data.R.GPSVelNorth = 1.000000e-3f;
    data.R.GPSVelEast = 1.000000e-3f;
    data.R.GPSVelDown = 1.000000e-3f;
    data.R.MagX = 1.000000e+1f;
    data.R.MagY = 1.000000e+1f;
    data.R.MagZ = 1.000000e+1f;
    data.R.BaroZ = 1.000000e-2f;
    data.FakeR.FakeGPSPosIndoor = 1.000000e+1f;
    data.FakeR.FakeGPSVelIndoor = 1.000000e+0f;
    data.FakeR.FakeGPSVelAirspeed = 1.000000e+3f;
