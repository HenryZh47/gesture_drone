...
void FixedWingPathFollowerSettingsSetDefaults(UAVObjHandle obj, uint16_t instId)
{
    ...
    data.HorizontalVelMax = 2.000000e+1f;
    data.HorizontalVelMin = 1.000000e+1f;
    data.VerticalVelMax = 1.000000e+1f;
    data.CourseFeedForward = 1.000000e+0f;
    data.ReverseCourseOverlap = 2.000000e+1f;
    data.HorizontalPosP = 2.000000e-1f;
    data.VerticalPosP = 4.000000e-1f;
    data.CoursePI.Kp = 2.000000e-1f;
    data.CoursePI.Ki = 0.000000e+0f;
    data.CoursePI.ILimit = 0.000000e+0f;
    data.SpeedPI.Kp = 2.500000e+0f;
    data.SpeedPI.Ki = 2.500000e-1f;
    data.SpeedPI.ILimit = 1.000000e+1f;
    data.VerticalToPitchCrossFeed.Kp = 5.000000e+0f;
    data.VerticalToPitchCrossFeed.Max = 1.000000e+1f;
    data.AirspeedToPowerCrossFeed.Kp = 2.000000e-1f;
    data.AirspeedToPowerCrossFeed.Max = 1.000000e+0f;
    data.PowerPI.Kp = 1.000000e-2f;
    data.PowerPI.Ki = 5.000000e-2f;
    data.PowerPI.ILimit = 5.000000e-1f;
    data.RollLimit.Min = -4.500000e+1f;
    data.RollLimit.Neutral = 0.000000e+0f;
    data.RollLimit.Max = 4.500000e+1f;
    data.PitchLimit.Min = -1.000000e+1f;
    data.PitchLimit.Neutral = 5.000000e+0f;
    data.PitchLimit.Max = 2.000000e+1f;
    data.ThrustLimit.Min = 1.000000e-1f;
    data.ThrustLimit.Neutral = 5.000000e-1f;
    data.ThrustLimit.Max = 9.000000e-1f;
    data.Safetymargins.Wind = 1.000000e+0f;
    data.Safetymargins.Stallspeed = 1.000000e+0f;
    data.Safetymargins.Lowspeed = 5.000000e-1f;
    data.Safetymargins.Highspeed = 1.500000e+0f;
    data.Safetymargins.Overspeed = 1.000000e+0f;
    data.Safetymargins.Lowpower = 1.000000e+0f;
    data.Safetymargins.Highpower = 0.000000e+0f;
    data.Safetymargins.Rollcontrol = 1.000000e+0f;
    data.Safetymargins.Pitchcontrol = 1.000000e+0f;
    data.SafetyCutoffLimits.RollDeg = 2.500000e+1f;
    data.SafetyCutoffLimits.PitchDeg = 2.500000e+1f;
    data.SafetyCutoffLimits.YawDeg = 2.500000e+1f;
    data.SafetyCutoffLimits.MaxDecelerationDeltaMPS = 4.000000e+0f;
    data.TakeOffPitch = 2.500000e+1f;
    data.LandingPitch = 7.500000e+0f;
