...
void FlightBatteryStateSetDefaults(UAVObjHandle obj, uint16_t instId)
{
    ...
    data.Voltage = 0.000000e+0f;
    data.Current = 0.000000e+0f;
    data.BoardSupplyVoltage = 0.000000e+0f;
    data.PeakCurrent = 0.000000e+0f;
    data.AvgCurrent = 0.000000e+0f;
    data.ConsumedEnergy = 0.000000e+0f;
    data.EstimatedFlightTime = 0.000000e+0f;
    data.NbCells = 3;
