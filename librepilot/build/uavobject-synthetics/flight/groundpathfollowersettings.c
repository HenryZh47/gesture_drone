...
void GroundPathFollowerSettingsSetDefaults(UAVObjHandle obj, uint16_t instId)
{
    ...
    data.HorizontalVelMax = 2.000000e+0f;
    data.HorizontalVelMin = 0.000000e+0f;
    data.CourseFeedForward = 3.000000e+0f;
    data.VelocityFeedForward = 1.000000e-1f;
    data.HorizontalPosP = 2.000000e-1f;
    data.SpeedPI.Kp = 1.000000e-1f;
    data.SpeedPI.Ki = 1.000000e-1f;
    data.SpeedPI.Kd = 1.000000e-3f;
    data.SpeedPI.Beta = 8.000000e-1f;
    data.ThrustLimit.Min = -3.000000e-1f;
    data.ThrustLimit.SlowForward = 1.500000e-1f;
    data.ThrustLimit.Max = 3.000000e-1f;
