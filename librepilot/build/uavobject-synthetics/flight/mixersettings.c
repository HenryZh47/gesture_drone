...
void MixerSettingsSetDefaults(UAVObjHandle obj, uint16_t instId)
{
    ...
    data.ThrottleCurve1[0] = 0.000000e+0f;
    data.ThrottleCurve1[1] = 0.000000e+0f;
    data.ThrottleCurve1[2] = 0.000000e+0f;
    data.ThrottleCurve1[3] = 0.000000e+0f;
    data.ThrottleCurve1[4] = 0.000000e+0f;
    data.ThrottleCurve2[0] = 0.000000e+0f;
    data.ThrottleCurve2[1] = 2.500000e-1f;
    data.ThrottleCurve2[2] = 5.000000e-1f;
    data.ThrottleCurve2[3] = 7.500000e-1f;
    data.ThrottleCurve2[4] = 1.000000e+0f;
