...
void StabilizationSettingsSetDefaults(UAVObjHandle obj, uint16_t instId)
{
    ...
    data.VbarSensitivity.Roll = 5.000000e-1f;
    data.VbarSensitivity.Pitch = 5.000000e-1f;
    data.VbarSensitivity.Yaw = 5.000000e-1f;
    data.VbarRollPI.Kp = 5.000000e-3f;
    data.VbarRollPI.Ki = 2.000000e-3f;
    data.VbarPitchPI.Kp = 5.000000e-3f;
    data.VbarPitchPI.Ki = 2.000000e-3f;
    data.VbarYawPI.Kp = 5.000000e-3f;
    data.VbarYawPI.Ki = 2.000000e-3f;
    data.VbarTau = 5.000000e-1f;
    data.GyroTau = 3.000000e-3f;
    data.DerivativeGamma = 1.000000e+0f;
    data.AxisLockKp = 2.500000e+0f;
    data.WeakLevelingKp = 1.000000e-1f;
    data.CruiseControlMaxPowerFactor = 3.000000e+0f;
    data.CruiseControlPowerTrim = 1.000000e+2f;
    data.CruiseControlPowerDelayComp = 2.500000e-1f;
    data.ScaleToAirspeed = 0.000000e+0f;
    data.ScaleToAirspeedLimits.Min = 5.000000e-2f;
    data.ScaleToAirspeedLimits.Max = 3.000000e+0f;
