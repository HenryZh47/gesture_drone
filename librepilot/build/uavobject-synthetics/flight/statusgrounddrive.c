...
void StatusGroundDriveSetDefaults(UAVObjHandle obj, uint16_t instId)
{
    ...
    data.NECommand.North = 0.000000e+0f;
    data.NECommand.East = 0.000000e+0f;
    data.State.Yaw = 0.000000e+0f;
    data.State.Velocity = 0.000000e+0f;
    data.State.Thrust = 0.000000e+0f;
    data.BodyCommand.Forward = 0.000000e+0f;
    data.BodyCommand.Right = 0.000000e+0f;
    data.ControlCommand.Speed = 0.000000e+0f;
    data.ControlCommand.Course = 0.000000e+0f;
