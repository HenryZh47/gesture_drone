...
void TxPIDSettingsSetDefaults(UAVObjHandle obj, uint16_t instId)
{
    ...
    data.ThrottleRange.Min = 2.000000e-1f;
    data.ThrottleRange.Max = 8.000000e-1f;
    data.MinPID.Instance1 = 0.000000e+0f;
    data.MinPID.Instance2 = 0.000000e+0f;
    data.MinPID.Instance3 = 0.000000e+0f;
    data.MaxPID.Instance1 = 0.000000e+0f;
    data.MaxPID.Instance2 = 0.000000e+0f;
    data.MaxPID.Instance3 = 0.000000e+0f;
    data.EasyTunePitchRollRateFactors.I = 3.000000e+0f;
    data.EasyTunePitchRollRateFactors.D = 1.350000e-2f;
    data.EasyTuneYawRateFactors.P = 1.500000e+0f;
    data.EasyTuneYawRateFactors.I = 1.900000e+0f;
    data.EasyTuneYawRateFactors.D = 8.500000e-3f;
    data.UpdateMode = 1;
    data.BankNumber = 0;
