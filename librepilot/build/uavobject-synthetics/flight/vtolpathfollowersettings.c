...
void VtolPathFollowerSettingsSetDefaults(UAVObjHandle obj, uint16_t instId)
{
    ...
    data.HorizontalVelMax = 1.000000e+1f;
    data.VerticalVelMax = 4.000000e+0f;
    data.CourseFeedForward = 1.000000e+0f;
    data.HorizontalPosP = 2.500000e-1f;
    data.VerticalPosP = 3.000000e-1f;
    data.HorizontalVelPID.Kp = 8.000000e+0f;
    data.HorizontalVelPID.Ki = 5.000000e-1f;
    data.HorizontalVelPID.Kd = 1.000000e-3f;
    data.HorizontalVelPID.Beta = 9.500000e-1f;
    data.VerticalVelPID.Kp = 1.500000e-1f;
    data.VerticalVelPID.Ki = 2.500000e-1f;
    data.VerticalVelPID.Kd = 5.000000e-3f;
    data.VerticalVelPID.Beta = 9.500000e-1f;
    data.ThrustLimits.Min = 2.000000e-1f;
    data.ThrustLimits.Neutral = 5.000000e-1f;
    data.ThrustLimits.Max = 9.000000e-1f;
    data.VelocityFeedforward = 2.000000e+0f;
    data.FlyawayEmergencyFallbackTriggerTime = 1.000000e+1f;
    data.EmergencyFallbackAttitude.Roll = 0.000000e+0f;
    data.EmergencyFallbackAttitude.Pitch = -2.000000e+1f;
    data.EmergencyFallbackYawRate.kP = 2.000000e+0f;
    data.EmergencyFallbackYawRate.Max = 3.000000e+1f;
    data.MaxRollPitch = 2.500000e+1f;
    data.BrakeRate = 2.500000e+0f;
    data.BrakeMaxPitch = 2.500000e+1f;
    data.BrakeHorizontalVelPID.Kp = 1.800000e+1f;
    data.BrakeHorizontalVelPID.Ki = 0.000000e+0f;
    data.BrakeHorizontalVelPID.Kd = 1.000000e-3f;
    data.BrakeHorizontalVelPID.Beta = 9.500000e-1f;
    data.BrakeVelocityFeedforward = 0.000000e+0f;
    data.LandVerticalVelPID.Kp = 4.200000e-1f;
    data.LandVerticalVelPID.Ki = 3.000000e+0f;
    data.LandVerticalVelPID.Kd = 2.000000e-2f;
    data.LandVerticalVelPID.Beta = 9.500000e-1f;
    data.AutoTakeoffVerticalVelPID.Kp = 4.200000e-1f;
    data.AutoTakeoffVerticalVelPID.Ki = 3.000000e+0f;
    data.AutoTakeoffVerticalVelPID.Kd = 2.000000e-2f;
    data.AutoTakeoffVerticalVelPID.Beta = 9.500000e-1f;
    data.VelocityRoamMaxRollPitch = 2.000000e+1f;
    data.VelocityRoamHorizontalVelPID.Kp = 1.200000e+1f;
    data.VelocityRoamHorizontalVelPID.Ki = 5.000000e-1f;
    data.VelocityRoamHorizontalVelPID.Kd = 1.000000e-3f;
    data.VelocityRoamHorizontalVelPID.Beta = 9.500000e-1f;
