...
class AuxMagSensorConstants : public QObject {
    Q_OBJECT
public:
...
class AuxMagSensor_Status : public QObject {
    Q_OBJECT
public:
    enum Enum { None, Ok };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
...
class UAVOBJECTS_EXPORT AuxMagSensor: public UAVDataObject
{
    Q_OBJECT
    Q_PROPERTY(float x READ x WRITE setX NOTIFY xChanged)
    Q_PROPERTY(float y READ y WRITE setY NOTIFY yChanged)
    Q_PROPERTY(float z READ z WRITE setZ NOTIFY zChanged)
    Q_PROPERTY(AuxMagSensor_Status::Enum status READ status WRITE setStatus NOTIFY statusChanged)
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0x9B459A2;
    ...
    static AuxMagSensor* GetInstance(UAVObjectManager* objMngr, quint32 instID = 0);
    ...
    AuxMagSensor_Status::Enum status() const;
...
public slots:
    ...
    void setStatus(const AuxMagSensor_Status::Enum value);
    /*DEPRECATED*/ void setStatus(quint8 value) { setStatus(static_cast<AuxMagSensor_Status::Enum>(value)); }
...
signals:
    ...
    void statusChanged(const AuxMagSensor_Status::Enum value);
