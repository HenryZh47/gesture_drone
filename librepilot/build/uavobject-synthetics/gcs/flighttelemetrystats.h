...
class FlightTelemetryStatsConstants : public QObject {
    Q_OBJECT
public:
...
class FlightTelemetryStats_Status : public QObject {
    Q_OBJECT
public:
...
class UAVOBJECTS_EXPORT FlightTelemetryStats: public UAVDataObject
{
    ...
    Q_PROPERTY(FlightTelemetryStats_Status::Enum status READ status WRITE setStatus NOTIFY statusChanged)
...
public:
    ...
    FlightTelemetryStats_Status::Enum status() const;
...
public slots:
    ...
    void setStatus(const FlightTelemetryStats_Status::Enum value);
    /*DEPRECATED*/ void setStatus(quint8 value) { setStatus(static_cast<FlightTelemetryStats_Status::Enum>(value)); }
...
signals:
    ...
    void statusChanged(const FlightTelemetryStats_Status::Enum value);
