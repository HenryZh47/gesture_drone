...
class StabilizationBankConstants : public QObject {
    Q_OBJECT
public:
...
class StabilizationBank_EnablePiroComp : public QObject {
    Q_OBJECT
public:
...
class StabilizationBank_EnableThrustPIDScaling : public QObject {
    Q_OBJECT
public:
    enum Enum { False, True };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
...
class StabilizationBank_ThrustPIDScaleSource : public QObject {
    Q_OBJECT
public:
...
class StabilizationBank_ThrustPIDScaleTarget : public QObject {
    Q_OBJECT
public:
...
class StabilizationBank_ThrustPIDScaleAxes : public QObject {
    Q_OBJECT
public:
...
class UAVOBJECTS_EXPORT StabilizationBank: public UAVDataObject
{
    ...
    Q_PROPERTY(StabilizationBank_EnablePiroComp::Enum enablePiroComp READ enablePiroComp WRITE setEnablePiroComp NOTIFY enablePiroCompChanged)
    ...
    Q_PROPERTY(StabilizationBank_EnableThrustPIDScaling::Enum enableThrustPIDScaling READ enableThrustPIDScaling WRITE setEnableThrustPIDScaling NOTIFY enableThrustPIDScalingChanged)
    ...
    Q_PROPERTY(StabilizationBank_ThrustPIDScaleSource::Enum thrustPIDScaleSource READ thrustPIDScaleSource WRITE setThrustPIDScaleSource NOTIFY thrustPIDScaleSourceChanged)
    Q_PROPERTY(StabilizationBank_ThrustPIDScaleTarget::Enum thrustPIDScaleTarget READ thrustPIDScaleTarget WRITE setThrustPIDScaleTarget NOTIFY thrustPIDScaleTargetChanged)
    Q_PROPERTY(StabilizationBank_ThrustPIDScaleAxes::Enum thrustPIDScaleAxes READ thrustPIDScaleAxes WRITE setThrustPIDScaleAxes NOTIFY thrustPIDScaleAxesChanged)
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0x373871F0;
    ...
    StabilizationBank_EnablePiroComp::Enum enablePiroComp() const;
    ...
    StabilizationBank_EnableThrustPIDScaling::Enum enableThrustPIDScaling() const;
...
public slots:
    ...
    void setEnablePiroComp(const StabilizationBank_EnablePiroComp::Enum value);
    /*DEPRECATED*/ void setEnablePiroComp(quint8 value) { setEnablePiroComp(static_cast<StabilizationBank_EnablePiroComp::Enum>(value)); }
    ...
    void setEnableThrustPIDScaling(const StabilizationBank_EnableThrustPIDScaling::Enum value);
    /*DEPRECATED*/ void setEnableThrustPIDScaling(quint8 value) { setEnableThrustPIDScaling(static_cast<StabilizationBank_EnableThrustPIDScaling::Enum>(value)); }
    ...
    void setThrustPIDScaleSource(const StabilizationBank_ThrustPIDScaleSource::Enum value);
    /*DEPRECATED*/ void setThrustPIDScaleSource(quint8 value) { setThrustPIDScaleSource(static_cast<StabilizationBank_ThrustPIDScaleSource::Enum>(value)); }
    void setThrustPIDScaleTarget(const StabilizationBank_ThrustPIDScaleTarget::Enum value);
    /*DEPRECATED*/ void setThrustPIDScaleTarget(quint8 value) { setThrustPIDScaleTarget(static_cast<StabilizationBank_ThrustPIDScaleTarget::Enum>(value)); }
    void setThrustPIDScaleAxes(const StabilizationBank_ThrustPIDScaleAxes::Enum value);
    /*DEPRECATED*/ void setThrustPIDScaleAxes(quint8 value) { setThrustPIDScaleAxes(static_cast<StabilizationBank_ThrustPIDScaleAxes::Enum>(value)); }
...
signals:
    ...
    void enablePiroCompChanged(const StabilizationBank_EnablePiroComp::Enum value);
    ...
    void enableThrustPIDScalingChanged(const StabilizationBank_EnableThrustPIDScaling::Enum value);
    ...
    void thrustPIDScaleSourceChanged(const StabilizationBank_ThrustPIDScaleSource::Enum value);
    /*DEPRECATED*/ void ThrustPIDScaleSourceChanged(quint8 value);
    void thrustPIDScaleTargetChanged(const StabilizationBank_ThrustPIDScaleTarget::Enum value);
    /*DEPRECATED*/ void ThrustPIDScaleTargetChanged(quint8 value);
    void thrustPIDScaleAxesChanged(const StabilizationBank_ThrustPIDScaleAxes::Enum value);
