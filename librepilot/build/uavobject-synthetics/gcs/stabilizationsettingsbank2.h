...
class StabilizationSettingsBank2Constants : public QObject {
    Q_OBJECT
public:
...
class StabilizationSettingsBank2_EnablePiroComp : public QObject {
    Q_OBJECT
public:
...
class StabilizationSettingsBank2_EnableThrustPIDScaling : public QObject {
    Q_OBJECT
public:
    enum Enum { False, True };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
...
class StabilizationSettingsBank2_ThrustPIDScaleSource : public QObject {
    Q_OBJECT
public:
...
class StabilizationSettingsBank2_ThrustPIDScaleTarget : public QObject {
    Q_OBJECT
public:
...
class StabilizationSettingsBank2_ThrustPIDScaleAxes : public QObject {
    Q_OBJECT
public:
...
class UAVOBJECTS_EXPORT StabilizationSettingsBank2: public UAVDataObject
{
    ...
    Q_PROPERTY(StabilizationSettingsBank2_EnablePiroComp::Enum enablePiroComp READ enablePiroComp WRITE setEnablePiroComp NOTIFY enablePiroCompChanged)
    ...
    Q_PROPERTY(StabilizationSettingsBank2_EnableThrustPIDScaling::Enum enableThrustPIDScaling READ enableThrustPIDScaling WRITE setEnableThrustPIDScaling NOTIFY enableThrustPIDScalingChanged)
    ...
    Q_PROPERTY(StabilizationSettingsBank2_ThrustPIDScaleSource::Enum thrustPIDScaleSource READ thrustPIDScaleSource WRITE setThrustPIDScaleSource NOTIFY thrustPIDScaleSourceChanged)
    Q_PROPERTY(StabilizationSettingsBank2_ThrustPIDScaleTarget::Enum thrustPIDScaleTarget READ thrustPIDScaleTarget WRITE setThrustPIDScaleTarget NOTIFY thrustPIDScaleTargetChanged)
    Q_PROPERTY(StabilizationSettingsBank2_ThrustPIDScaleAxes::Enum thrustPIDScaleAxes READ thrustPIDScaleAxes WRITE setThrustPIDScaleAxes NOTIFY thrustPIDScaleAxesChanged)
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0xE039134;
    ...
    StabilizationSettingsBank2_EnablePiroComp::Enum enablePiroComp() const;
    ...
    StabilizationSettingsBank2_EnableThrustPIDScaling::Enum enableThrustPIDScaling() const;
    ...
    StabilizationSettingsBank2_ThrustPIDScaleSource::Enum thrustPIDScaleSource() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getThrustPIDScaleSource() const { return static_cast<quint8>(thrustPIDScaleSource()); }
    StabilizationSettingsBank2_ThrustPIDScaleTarget::Enum thrustPIDScaleTarget() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getThrustPIDScaleTarget() const { return static_cast<quint8>(thrustPIDScaleTarget()); }
    StabilizationSettingsBank2_ThrustPIDScaleAxes::Enum thrustPIDScaleAxes() const;
...
public slots:
    ...
    void setEnablePiroComp(const StabilizationSettingsBank2_EnablePiroComp::Enum value);
    /*DEPRECATED*/ void setEnablePiroComp(quint8 value) { setEnablePiroComp(static_cast<StabilizationSettingsBank2_EnablePiroComp::Enum>(value)); }
    ...
    void setEnableThrustPIDScaling(const StabilizationSettingsBank2_EnableThrustPIDScaling::Enum value);
    /*DEPRECATED*/ void setEnableThrustPIDScaling(quint8 value) { setEnableThrustPIDScaling(static_cast<StabilizationSettingsBank2_EnableThrustPIDScaling::Enum>(value)); }
    ...
    void setThrustPIDScaleSource(const StabilizationSettingsBank2_ThrustPIDScaleSource::Enum value);
    /*DEPRECATED*/ void setThrustPIDScaleSource(quint8 value) { setThrustPIDScaleSource(static_cast<StabilizationSettingsBank2_ThrustPIDScaleSource::Enum>(value)); }
    void setThrustPIDScaleTarget(const StabilizationSettingsBank2_ThrustPIDScaleTarget::Enum value);
    /*DEPRECATED*/ void setThrustPIDScaleTarget(quint8 value) { setThrustPIDScaleTarget(static_cast<StabilizationSettingsBank2_ThrustPIDScaleTarget::Enum>(value)); }
    void setThrustPIDScaleAxes(const StabilizationSettingsBank2_ThrustPIDScaleAxes::Enum value);
    /*DEPRECATED*/ void setThrustPIDScaleAxes(quint8 value) { setThrustPIDScaleAxes(static_cast<StabilizationSettingsBank2_ThrustPIDScaleAxes::Enum>(value)); }
...
signals:
    ...
    void enablePiroCompChanged(const StabilizationSettingsBank2_EnablePiroComp::Enum value);
    ...
    void enableThrustPIDScalingChanged(const StabilizationSettingsBank2_EnableThrustPIDScaling::Enum value);
    ...
    void thrustPIDScaleSourceChanged(const StabilizationSettingsBank2_ThrustPIDScaleSource::Enum value);
    /*DEPRECATED*/ void ThrustPIDScaleSourceChanged(quint8 value);
    void thrustPIDScaleTargetChanged(const StabilizationSettingsBank2_ThrustPIDScaleTarget::Enum value);
    /*DEPRECATED*/ void ThrustPIDScaleTargetChanged(quint8 value);
    void thrustPIDScaleAxesChanged(const StabilizationSettingsBank2_ThrustPIDScaleAxes::Enum value);
