...
class StabilizationSettingsBank3Constants : public QObject {
    Q_OBJECT
public:
...
class StabilizationSettingsBank3_EnablePiroComp : public QObject {
    Q_OBJECT
public:
...
class StabilizationSettingsBank3_EnableThrustPIDScaling : public QObject {
    Q_OBJECT
public:
    enum Enum { False, True };
    Q_ENUMS(Enum) // TODO switch to Q_ENUM once on Qt 5.5
...
class StabilizationSettingsBank3_ThrustPIDScaleSource : public QObject {
    Q_OBJECT
public:
...
class StabilizationSettingsBank3_ThrustPIDScaleTarget : public QObject {
    Q_OBJECT
public:
...
class StabilizationSettingsBank3_ThrustPIDScaleAxes : public QObject {
    Q_OBJECT
public:
...
class UAVOBJECTS_EXPORT StabilizationSettingsBank3: public UAVDataObject
{
    ...
    Q_PROPERTY(StabilizationSettingsBank3_EnablePiroComp::Enum enablePiroComp READ enablePiroComp WRITE setEnablePiroComp NOTIFY enablePiroCompChanged)
    ...
    Q_PROPERTY(StabilizationSettingsBank3_EnableThrustPIDScaling::Enum enableThrustPIDScaling READ enableThrustPIDScaling WRITE setEnableThrustPIDScaling NOTIFY enableThrustPIDScalingChanged)
    ...
    Q_PROPERTY(StabilizationSettingsBank3_ThrustPIDScaleSource::Enum thrustPIDScaleSource READ thrustPIDScaleSource WRITE setThrustPIDScaleSource NOTIFY thrustPIDScaleSourceChanged)
    Q_PROPERTY(StabilizationSettingsBank3_ThrustPIDScaleTarget::Enum thrustPIDScaleTarget READ thrustPIDScaleTarget WRITE setThrustPIDScaleTarget NOTIFY thrustPIDScaleTargetChanged)
    Q_PROPERTY(StabilizationSettingsBank3_ThrustPIDScaleAxes::Enum thrustPIDScaleAxes READ thrustPIDScaleAxes WRITE setThrustPIDScaleAxes NOTIFY thrustPIDScaleAxesChanged)
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0x5C80D844;
    ...
    StabilizationSettingsBank3_EnablePiroComp::Enum enablePiroComp() const;
    ...
    StabilizationSettingsBank3_EnableThrustPIDScaling::Enum enableThrustPIDScaling() const;
    ...
    StabilizationSettingsBank3_ThrustPIDScaleSource::Enum thrustPIDScaleSource() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getThrustPIDScaleSource() const { return static_cast<quint8>(thrustPIDScaleSource()); }
    StabilizationSettingsBank3_ThrustPIDScaleTarget::Enum thrustPIDScaleTarget() const;
    /*DEPRECATED*/ Q_INVOKABLE quint8 getThrustPIDScaleTarget() const { return static_cast<quint8>(thrustPIDScaleTarget()); }
    StabilizationSettingsBank3_ThrustPIDScaleAxes::Enum thrustPIDScaleAxes() const;
...
public slots:
    ...
    void setEnablePiroComp(const StabilizationSettingsBank3_EnablePiroComp::Enum value);
    /*DEPRECATED*/ void setEnablePiroComp(quint8 value) { setEnablePiroComp(static_cast<StabilizationSettingsBank3_EnablePiroComp::Enum>(value)); }
    ...
    void setEnableThrustPIDScaling(const StabilizationSettingsBank3_EnableThrustPIDScaling::Enum value);
    /*DEPRECATED*/ void setEnableThrustPIDScaling(quint8 value) { setEnableThrustPIDScaling(static_cast<StabilizationSettingsBank3_EnableThrustPIDScaling::Enum>(value)); }
    ...
    void setThrustPIDScaleSource(const StabilizationSettingsBank3_ThrustPIDScaleSource::Enum value);
    /*DEPRECATED*/ void setThrustPIDScaleSource(quint8 value) { setThrustPIDScaleSource(static_cast<StabilizationSettingsBank3_ThrustPIDScaleSource::Enum>(value)); }
    void setThrustPIDScaleTarget(const StabilizationSettingsBank3_ThrustPIDScaleTarget::Enum value);
    /*DEPRECATED*/ void setThrustPIDScaleTarget(quint8 value) { setThrustPIDScaleTarget(static_cast<StabilizationSettingsBank3_ThrustPIDScaleTarget::Enum>(value)); }
    void setThrustPIDScaleAxes(const StabilizationSettingsBank3_ThrustPIDScaleAxes::Enum value);
    /*DEPRECATED*/ void setThrustPIDScaleAxes(quint8 value) { setThrustPIDScaleAxes(static_cast<StabilizationSettingsBank3_ThrustPIDScaleAxes::Enum>(value)); }
...
signals:
    ...
    void enablePiroCompChanged(const StabilizationSettingsBank3_EnablePiroComp::Enum value);
    ...
    void enableThrustPIDScalingChanged(const StabilizationSettingsBank3_EnableThrustPIDScaling::Enum value);
    ...
    void thrustPIDScaleSourceChanged(const StabilizationSettingsBank3_ThrustPIDScaleSource::Enum value);
    /*DEPRECATED*/ void ThrustPIDScaleSourceChanged(quint8 value);
    void thrustPIDScaleTargetChanged(const StabilizationSettingsBank3_ThrustPIDScaleTarget::Enum value);
    /*DEPRECATED*/ void ThrustPIDScaleTargetChanged(quint8 value);
    void thrustPIDScaleAxesChanged(const StabilizationSettingsBank3_ThrustPIDScaleAxes::Enum value);
