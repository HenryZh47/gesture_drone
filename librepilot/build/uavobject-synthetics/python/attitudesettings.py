...
# Field BoardSteadyMaxVariance definition
class BoardSteadyMaxVarianceField(UAVObjectField):
    def __init__(self):
        UAVObjectField.__init__(self, 6, 1)
...
# Field InitialZeroWhenBoardSteady definition
class InitialZeroWhenBoardSteadyField(UAVObjectField):
    # Enumeration options
    FALSE = 0
    TRUE = 1
    def __init__(self):
...
class AttitudeSettings(UAVObject):
    ...
    def __init__(self):
        ...
        self.BoardSteadyMaxVariance = BoardSteadyMaxVarianceField()
        self.addField(self.BoardSteadyMaxVariance)
        ...
        self.InitialZeroWhenBoardSteady = InitialZeroWhenBoardSteadyField()
        self.addField(self.InitialZeroWhenBoardSteady)
