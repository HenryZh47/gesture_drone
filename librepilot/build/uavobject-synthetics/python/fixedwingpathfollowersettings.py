...
# Field SafetyCutoffLimits definition
class SafetyCutoffLimitsField(UAVObjectField):
    # Array element names
    ROLLDEG = 0
    PITCHDEG = 1
    YAWDEG = 2
    MAXDECELERATIONDELTAMPS = 3
    def __init__(self):
        UAVObjectField.__init__(self, 6, 4)

# Field TakeOffPitch definition
class TakeOffPitchField(UAVObjectField):
    def __init__(self):
        UAVObjectField.__init__(self, 6, 1)

# Field LandingPitch definition
class LandingPitchField(UAVObjectField):
    def __init__(self):
        UAVObjectField.__init__(self, 6, 1)
...
# Field UseAirspeedSensor definition
class UseAirspeedSensorField(UAVObjectField):
    # Enumeration options
    FALSE = 0
    TRUE = 1
    def __init__(self):
...
class FixedWingPathFollowerSettings(UAVObject):
    ...
    def __init__(self):
        ...
        self.SafetyCutoffLimits = SafetyCutoffLimitsField()
        self.addField(self.SafetyCutoffLimits)
        self.TakeOffPitch = TakeOffPitchField()
        self.addField(self.TakeOffPitch)
        self.LandingPitch = LandingPitchField()
        self.addField(self.LandingPitch)
        self.UpdatePeriod = UpdatePeriodField()
        self.addField(self.UpdatePeriod)
        self.UseAirspeedSensor = UseAirspeedSensorField()
        self.addField(self.UseAirspeedSensor)
