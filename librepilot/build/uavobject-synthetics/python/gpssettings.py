...
class UbxAutoConfigField(UAVObjectField):
    ...
    DISABLED = 0
    AUTOBAUD = 1
    AUTOBAUDANDCONFIGURE = 2
    AUTOBAUDCONFIGUREANDSTORE = 3
    AUTOBAUDCONFIGURESTOREANDDISABLE = 4
    def __init__(self):
        UAVObjectField.__init__(self, 7, 1)
...
# Field UbxAssistNowAutonomous definition
class UbxAssistNowAutonomousField(UAVObjectField):
    # Enumeration options
    FALSE = 0
    TRUE = 1
    def __init__(self):
...
class GPSSettings(UAVObject):
    ...
    def __init__(self):
        ...
        self.UbxAssistNowAutonomous = UbxAssistNowAutonomousField()
        self.addField(self.UbxAssistNowAutonomous)
