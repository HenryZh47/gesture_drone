...
# Field SensorReadTimestamp definition
class SensorReadTimestampField(UAVObjectField):
    def __init__(self):
...
class GyroState(UAVObject):
    ...
    def __init__(self):
        ...
        self.SensorReadTimestamp = SensorReadTimestampField()
        self.addField(self.SensorReadTimestamp)
