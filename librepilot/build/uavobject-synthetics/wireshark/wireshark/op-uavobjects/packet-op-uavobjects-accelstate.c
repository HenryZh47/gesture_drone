/*
  * !!! Autogenerated from accelstate.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_accelstate_x = -1;
static int hf_op_uavobjects_accelstate_y = -1;
static int hf_op_uavobjects_accelstate_z = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_accelstate(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(AccelState)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_accelstate_x, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_accelstate_y, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_accelstate_z, sizeof(gfloat), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_accelstate(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_accelstate_x,
	   { "x", "accelstate.x", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_accelstate_y,
	   { "y", "accelstate.y", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_accelstate_z,
	   { "z", "accelstate.z", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO AccelState", 
				   "UAVO AccelState", 
				   "uavo-accelstate");
...
void proto_reg_handoff_op_uavobjects_accelstate(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0xAD3C0E06, uavo_handle);
}
