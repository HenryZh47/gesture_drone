/*
  * !!! Autogenerated from accessorydesired.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_accessorydesired_AccessoryVal = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_accessorydesired(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(AccessoryDesired)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_accessorydesired_AccessoryVal, sizeof(gfloat), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_accessorydesired(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_accessorydesired_AccessoryVal,
	   { "AccessoryVal", "accessorydesired.AccessoryVal", FT_FLOAT,
   ...
   proto_uavo = proto_register_protocol("UAVO AccessoryDesired", 
				   "UAVO AccessoryDesired", 
				   "uavo-accessorydesired");
...
void proto_reg_handoff_op_uavobjects_accessorydesired(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0xC409985A, uavo_handle);
}
