/*
  * !!! Autogenerated from airspeedstate.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_airspeedstate_CalibratedAirspeed = -1;
static int hf_op_uavobjects_airspeedstate_TrueAirspeed = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_airspeedstate(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(AirspeedState)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_airspeedstate_CalibratedAirspeed, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_airspeedstate_TrueAirspeed, sizeof(gfloat), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_airspeedstate(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_airspeedstate_CalibratedAirspeed,
	   { "CalibratedAirspeed", "airspeedstate.CalibratedAirspeed", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_airspeedstate_TrueAirspeed,
	   { "TrueAirspeed", "airspeedstate.TrueAirspeed", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO AirspeedState", 
				   "UAVO AirspeedState", 
				   "uavo-airspeedstate");
...
void proto_reg_handoff_op_uavobjects_airspeedstate(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0xC7009F28, uavo_handle);
}
