/*
  * !!! Autogenerated from debuglogsettings.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_debuglogsettings_LoggingEnabled = -1;


/* Enum string mappings */
/* Field LoggingEnabled information */
/* Enumeration options for field LoggingEnabled */
static const value_string uavobjects_debuglogsettings_LoggingEnabled[]= {
	{ 0, "Disabled" },
	{ 1, "OnlyWhenArmed" },
	{ 2, "Always" },
	{ 0, NULL }
...
void proto_reg_handoff_op_uavobjects_debuglogsettings(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(DebugLogSettings)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_debuglogsettings_LoggingEnabled, sizeof(guint8), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_debuglogsettings(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_debuglogsettings_LoggingEnabled,
	   { "LoggingEnabled", "debuglogsettings.LoggingEnabled", FT_UINT8,
	     BASE_DEC, VALS(uavobjects_debuglogsettings_LoggingEnabled), 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO DebugLogSettings", 
				   "UAVO DebugLogSettings", 
				   "uavo-debuglogsettings");
...
void proto_reg_handoff_op_uavobjects_debuglogsettings(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0x5E5903CC, uavo_handle);
}
