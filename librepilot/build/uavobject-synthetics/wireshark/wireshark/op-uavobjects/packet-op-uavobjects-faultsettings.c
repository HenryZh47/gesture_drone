/*
  * !!! Autogenerated from faultsettings.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_faultsettings_ActivateFault = -1;


/* Enum string mappings */
/* Field ActivateFault information */
/* Enumeration options for field ActivateFault */
static const value_string uavobjects_faultsettings_ActivateFault[]= {
	{ 0, "NoFault" },
	{ 1, "ModuleInitAssert" },
	{ 2, "InitOutOfMemory" },
	{ 3, "InitBusError" },
...
void proto_reg_handoff_op_uavobjects_faultsettings(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(FaultSettings)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_faultsettings_ActivateFault, sizeof(guint8), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_faultsettings(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_faultsettings_ActivateFault,
	   { "ActivateFault", "faultsettings.ActivateFault", FT_UINT8,
	     BASE_DEC, VALS(uavobjects_faultsettings_ActivateFault), 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO FaultSettings", 
				   "UAVO FaultSettings", 
				   "uavo-faultsettings");
...
void proto_reg_handoff_op_uavobjects_faultsettings(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0x2778BA3C, uavo_handle);
}
