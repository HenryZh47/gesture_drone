/*
  * !!! Autogenerated from flightplancontrol.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_flightplancontrol_Command = -1;


/* Enum string mappings */
/* Field Command information */
/* Enumeration options for field Command */
static const value_string uavobjects_flightplancontrol_Command[]= {
	{ 0, "Start" },
	{ 1, "Stop" },
	{ 2, "Kill" },
	{ 0, NULL }
...
void proto_reg_handoff_op_uavobjects_flightplancontrol(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(FlightPlanControl)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_flightplancontrol_Command, sizeof(guint8), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_flightplancontrol(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_flightplancontrol_Command,
	   { "Command", "flightplancontrol.Command", FT_UINT8,
	     BASE_DEC, VALS(uavobjects_flightplancontrol_Command), 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO FlightPlanControl", 
				   "UAVO FlightPlanControl", 
				   "uavo-flightplancontrol");
...
void proto_reg_handoff_op_uavobjects_flightplancontrol(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0x53E3F180, uavo_handle);
}
