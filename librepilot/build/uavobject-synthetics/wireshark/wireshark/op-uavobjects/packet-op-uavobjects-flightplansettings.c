/*
  * !!! Autogenerated from flightplansettings.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_flightplansettings_Test = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_flightplansettings(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(FlightPlanSettings)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_flightplansettings_Test, sizeof(gfloat), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_flightplansettings(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_flightplansettings_Test,
	   { "Test", "flightplansettings.Test", FT_FLOAT,
   ...
   proto_uavo = proto_register_protocol("UAVO FlightPlanSettings", 
				   "UAVO FlightPlanSettings", 
				   "uavo-flightplansettings");
...
void proto_reg_handoff_op_uavobjects_flightplansettings(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0x92E9FF76, uavo_handle);
}
