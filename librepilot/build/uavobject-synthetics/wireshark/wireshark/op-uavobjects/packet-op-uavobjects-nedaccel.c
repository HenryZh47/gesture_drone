/*
  * !!! Autogenerated from nedaccel.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_nedaccel_North = -1;
static int hf_op_uavobjects_nedaccel_East = -1;
static int hf_op_uavobjects_nedaccel_Down = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_nedaccel(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(NedAccel)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_nedaccel_North, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_nedaccel_East, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_nedaccel_Down, sizeof(gfloat), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_nedaccel(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_nedaccel_North,
	   { "North", "nedaccel.North", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_nedaccel_East,
	   { "East", "nedaccel.East", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_nedaccel_Down,
	   { "Down", "nedaccel.Down", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO NedAccel", 
				   "UAVO NedAccel", 
				   "uavo-nedaccel");
...
void proto_reg_handoff_op_uavobjects_nedaccel(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0x7C7F5BC0, uavo_handle);
}
