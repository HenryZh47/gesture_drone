/*
  * !!! Autogenerated from overosyncsettings.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_overosyncsettings_LogOn = -1;


/* Enum string mappings */
/* Field LogOn information */
/* Enumeration options for field LogOn */
static const value_string uavobjects_overosyncsettings_LogOn[]= {
	{ 0, "Never" },
	{ 1, "Always" },
	{ 2, "Armed" },
	{ 0, NULL }
...
void proto_reg_handoff_op_uavobjects_overosyncsettings(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(OveroSyncSettings)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_overosyncsettings_LogOn, sizeof(guint8), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_overosyncsettings(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_overosyncsettings_LogOn,
	   { "LogOn", "overosyncsettings.LogOn", FT_UINT8,
	     BASE_DEC, VALS(uavobjects_overosyncsettings_LogOn), 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO OveroSyncSettings", 
				   "UAVO OveroSyncSettings", 
				   "uavo-overosyncsettings");
...
void proto_reg_handoff_op_uavobjects_overosyncsettings(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0xA1ABC278, uavo_handle);
}
