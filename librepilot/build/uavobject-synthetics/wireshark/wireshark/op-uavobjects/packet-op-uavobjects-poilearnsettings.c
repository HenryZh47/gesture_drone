/*
  * !!! Autogenerated from poilearnsettings.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_poilearnsettings_Input = -1;


/* Enum string mappings */
/* Field Input information */
/* Enumeration options for field Input */
static const value_string uavobjects_poilearnsettings_Input[]= {
	{ 0, "Accessory0" },
	{ 1, "Accessory1" },
	{ 2, "Accessory2" },
	{ 3, "Accessory3" },
...
void proto_reg_handoff_op_uavobjects_poilearnsettings(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(PoiLearnSettings)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_poilearnsettings_Input, sizeof(guint8), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_poilearnsettings(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_poilearnsettings_Input,
	   { "Input", "poilearnsettings.Input", FT_UINT8,
	     BASE_DEC, VALS(uavobjects_poilearnsettings_Input), 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO PoiLearnSettings", 
				   "UAVO PoiLearnSettings", 
				   "uavo-poilearnsettings");
...
void proto_reg_handoff_op_uavobjects_poilearnsettings(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0x9E22E820, uavo_handle);
}
