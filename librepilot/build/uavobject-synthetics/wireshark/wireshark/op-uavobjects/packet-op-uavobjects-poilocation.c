/*
  * !!! Autogenerated from poilocation.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_poilocation_North = -1;
static int hf_op_uavobjects_poilocation_East = -1;
static int hf_op_uavobjects_poilocation_Down = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_poilocation(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(PoiLocation)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_poilocation_North, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_poilocation_East, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_poilocation_Down, sizeof(gfloat), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_poilocation(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_poilocation_North,
	   { "North", "poilocation.North", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_poilocation_East,
	   { "East", "poilocation.East", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_poilocation_Down,
	   { "Down", "poilocation.Down", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO PoiLocation", 
				   "UAVO PoiLocation", 
				   "uavo-poilocation");
...
void proto_reg_handoff_op_uavobjects_poilocation(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0x17E829B8, uavo_handle);
}
