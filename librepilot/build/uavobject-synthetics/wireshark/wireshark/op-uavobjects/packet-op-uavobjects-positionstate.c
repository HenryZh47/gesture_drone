/*
  * !!! Autogenerated from positionstate.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_positionstate_North = -1;
static int hf_op_uavobjects_positionstate_East = -1;
static int hf_op_uavobjects_positionstate_Down = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_positionstate(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(PositionState)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_positionstate_North, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_positionstate_East, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_positionstate_Down, sizeof(gfloat), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_positionstate(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_positionstate_North,
	   { "North", "positionstate.North", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_positionstate_East,
	   { "East", "positionstate.East", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_positionstate_Down,
	   { "Down", "positionstate.Down", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO PositionState", 
				   "UAVO PositionState", 
				   "uavo-positionstate");
...
void proto_reg_handoff_op_uavobjects_positionstate(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0x4AFDB658, uavo_handle);
}
