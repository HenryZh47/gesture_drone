/*
  * !!! Autogenerated from receiveractivity.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_receiveractivity_ActiveGroup = -1;
static int hf_op_uavobjects_receiveractivity_ActiveChannel = -1;


/* Enum string mappings */
/* Field ActiveGroup information */
/* Enumeration options for field ActiveGroup */
static const value_string uavobjects_receiveractivity_ActiveGroup[]= {
	{ 0, "PWM" },
	{ 1, "PPM" },
	{ 2, "DSMMainPort" },
	{ 3, "DSMFlexiPort" },
...
void proto_reg_handoff_op_uavobjects_receiveractivity(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(ReceiverActivity)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_receiveractivity_ActiveGroup, sizeof(guint8), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_receiveractivity_ActiveChannel, sizeof(guint8), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_receiveractivity(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_receiveractivity_ActiveGroup,
	   { "ActiveGroup", "receiveractivity.ActiveGroup", FT_UINT8,
	     BASE_DEC, VALS(uavobjects_receiveractivity_ActiveGroup), 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_receiveractivity_ActiveChannel,
	   { "ActiveChannel", "receiveractivity.ActiveChannel", FT_UINT8,
   ...
   proto_uavo = proto_register_protocol("UAVO ReceiverActivity", 
				   "UAVO ReceiverActivity", 
				   "uavo-receiveractivity");
...
void proto_reg_handoff_op_uavobjects_receiveractivity(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0xA00CB4AA, uavo_handle);
}
