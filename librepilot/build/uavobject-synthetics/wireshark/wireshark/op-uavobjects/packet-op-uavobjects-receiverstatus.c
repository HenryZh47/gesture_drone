/*
  * !!! Autogenerated from receiverstatus.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_receiverstatus_Quality = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_receiverstatus(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(ReceiverStatus)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_receiverstatus_Quality, sizeof(guint8), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_receiverstatus(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_receiverstatus_Quality,
	   { "Quality", "receiverstatus.Quality", FT_UINT8,
   ...
   proto_uavo = proto_register_protocol("UAVO ReceiverStatus", 
				   "UAVO ReceiverStatus", 
				   "uavo-receiverstatus");
...
void proto_reg_handoff_op_uavobjects_receiverstatus(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0xFD24EDF2, uavo_handle);
}
