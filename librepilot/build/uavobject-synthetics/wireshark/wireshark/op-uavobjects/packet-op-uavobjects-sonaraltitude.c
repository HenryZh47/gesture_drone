/*
  * !!! Autogenerated from sonaraltitude.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_sonaraltitude_Altitude = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_sonaraltitude(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(SonarAltitude)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_sonaraltitude_Altitude, sizeof(gfloat), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_sonaraltitude(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_sonaraltitude_Altitude,
	   { "Altitude", "sonaraltitude.Altitude", FT_FLOAT,
   ...
   proto_uavo = proto_register_protocol("UAVO SonarAltitude", 
				   "UAVO SonarAltitude", 
				   "uavo-sonaraltitude");
...
void proto_reg_handoff_op_uavobjects_sonaraltitude(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0x6C5A0CBC, uavo_handle);
}
