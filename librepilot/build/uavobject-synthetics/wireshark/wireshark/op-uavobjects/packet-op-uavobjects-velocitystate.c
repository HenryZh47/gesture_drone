/*
  * !!! Autogenerated from velocitystate.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_velocitystate_North = -1;
static int hf_op_uavobjects_velocitystate_East = -1;
static int hf_op_uavobjects_velocitystate_Down = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_velocitystate(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(VelocityState)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_velocitystate_North, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_velocitystate_East, sizeof(gfloat), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_velocitystate_Down, sizeof(gfloat), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_velocitystate(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_velocitystate_North,
	   { "North", "velocitystate.North", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_velocitystate_East,
	   { "East", "velocitystate.East", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
	 { &hf_op_uavobjects_velocitystate_Down,
	   { "Down", "velocitystate.Down", FT_FLOAT,
	     BASE_NONE, NULL, 0x0, NULL, HFILL 
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO VelocityState", 
				   "UAVO VelocityState", 
				   "uavo-velocitystate");
...
void proto_reg_handoff_op_uavobjects_velocitystate(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0xC243686C, uavo_handle);
}
