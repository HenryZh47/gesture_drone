/*
  * !!! Autogenerated from watchdogstatus.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_watchdogstatus_BootupFlags = -1;
static int hf_op_uavobjects_watchdogstatus_ActiveFlags = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_watchdogstatus(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(WatchdogStatus)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_watchdogstatus_BootupFlags, sizeof(guint16), ENC_LITTLE_ENDIAN);
    ptvcursor_add(cursor, hf_op_uavobjects_watchdogstatus_ActiveFlags, sizeof(guint16), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_watchdogstatus(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_watchdogstatus_BootupFlags,
	   { "BootupFlags", "watchdogstatus.BootupFlags", FT_UINT16,
	     BASE_DEC, NULL, 0x0, NULL, HFILL
	   },
	 },
	 { &hf_op_uavobjects_watchdogstatus_ActiveFlags,
	   { "ActiveFlags", "watchdogstatus.ActiveFlags", FT_UINT16,
	     BASE_DEC, NULL, 0x0, NULL, HFILL
	   },
	 },
   };
   ...
   proto_uavo = proto_register_protocol("UAVO WatchdogStatus", 
				   "UAVO WatchdogStatus", 
				   "uavo-watchdogstatus");
...
void proto_reg_handoff_op_uavobjects_watchdogstatus(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0xA207FA7C, uavo_handle);
}
