/*
  * !!! Autogenerated from waypointactive.xml Do NOT Edit !!!
  *
...
/* Field handles */
static int hf_op_uavobjects_waypointactive_Index = -1;


/* Enum string mappings */


void proto_reg_handoff_op_uavobjects_waypointactive(void);

static int dissect_uavo(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
  int offset = 0;

  col_append_str(pinfo->cinfo, COL_INFO, "(WaypointActive)");
  ...
  if (tree) { /* we are being asked for details */
    ...
    ptvcursor_add(cursor, hf_op_uavobjects_waypointactive_Index, sizeof(gint16), ENC_LITTLE_ENDIAN);
...
void proto_register_op_objects_waypointactive(void)
{
   static hf_register_info hf[] = {
	 { &hf_op_uavobjects_waypointactive_Index,
	   { "Index", "waypointactive.Index", FT_INT16,
   ...
   proto_uavo = proto_register_protocol("UAVO WaypointActive", 
				   "UAVO WaypointActive", 
				   "uavo-waypointactive");
...
void proto_reg_handoff_op_uavobjects_waypointactive(void)
{
   ...
   dissector_add_uint("uavtalk.objid", 0x1EA5B19C, uavo_handle);
}
